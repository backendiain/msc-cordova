...
function createPolygon(vertices, offset){
  ...
  if(typeof vertices === 'undefined'){
          var vertices = [
                      ...
                      new CANNON.Vec3(-5,35,0), //3
                      new CANNON.Vec3(70,0,-5), //4
                      new CANNON.Vec3(70,5,-5), //5
                      new CANNON.Vec3(-5,35,-5), // 6
...
function rollingBalls(Experiment){
  ...
  var slope_stopper_vertices = [
                          ...
                          new CANNON.Vec3(0,8.5,0), //2
                          new CANNON.Vec3(0,0,52), //3
                          new CANNON.Vec3(5,0,52), //4
                          new CANNON.Vec3(0,8.5,52) // 5
                      ];
  ...
  */
  ...
  var sphere_to_prism = new CANNON.ContactMaterial(slope_mat, sphere_mat, { friction: 0.1, restitution:0.9 });
